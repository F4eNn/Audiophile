...
export const CategoryProduct = ({ categoryImage, name, description, new: newProduct, rowReverse = 'lg:flex-row' }: CategoryProductProps) => {
	return (
		<AnimateSection>
			<div className={`flex flex-col gap-8 ${rowReverse} lg:items-center lg:justify-around `}>
				<div className='relative lg:aspect-square flex w-full lg:w-[500px] items-center justify-center overflow-hidden rounded-lg bg-rose'>
					<picture>
				...
				<div className='flex flex-col items-center gap-8 px-5 text-center lg:text-left lg:items-start'>
