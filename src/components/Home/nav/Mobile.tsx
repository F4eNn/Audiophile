	...
	return (
		...
		>
			<ul className='flex  items-center  justify-between  '>
				...
				<li ref={cartRef} className='flex items-center gap-5 opacity-0'>
			...
			<div
				...
				className='fixed -bottom-2 left-0 -z-50 h-0 w-full overflow-auto  bg-primaryDark/70'
			>
